...
namespace Unit04.Game.Services
{
    ...
    public class VideoService
    {
        ...
        public VideoService(string caption, int width, int height, int cellSize, int frameRate, int delay,
                bool debug)
        {
        ...
        /// <summary>
        /// Gets the game's delay constant.
        /// </summary>
        /// <returns>The delay constant.</returns>
        public int GetDelay()
        {
            return delay;
        }
